...
if repos['values'].find { |repo| repo['name'] == REPO_NAME }
  ...
  payload = {text: text, username: 'Deployment notifications', channel: '#general'}
  run %{curl -X POST https://hooks.slack.com/services/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 -d '#{payload.to_json}'}
